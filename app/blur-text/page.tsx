...
export default function Blurtext() {
    ...
    useEffect(() => {
        ...
        const loadtext = async () => {
            try{
                const response = await axios.get("/api/blurtext",{signal:abortcontroller.signal});
        ...
        <div>
            ...
            {select ? 
                ...
                <div className="border border-[#9c9c9c] mt-[20px] h-[400px] flex justify-center items-center rounded-[8px] relative">
                    ...
                    <BlurText key={resetanimation ? "active" : "inactive"} text={"Phu Wa don"} className="text-[#fff] text-[50px] font-bold"/>
                </div>
                :
                //code
